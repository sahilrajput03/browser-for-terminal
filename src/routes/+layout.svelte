...
<div class="p-4">
	...
	<div class="mb-3">
		<div>
			<a href="/">
				<h1 class="mb-2 text-2xl font-bold hover:text-pink-400">Browser For Terminal1</h1>
			</a>
			{#if dev}
				<div class="text-xs italic">
					...
					<a
						target="_blank"
						href="https://browser-for-terminal.vercel.app"
						class="text-blue-600 underline"
					>
						browser-for-terminal.vercel.app
					</a>
				</div>
			{/if}
		</div>
